...
const TabList = () => {
  return (
    <div className="my-10 w-full">
      <Tabs defaultValue="6 ශ්‍රේණිය" className="w-full max-w-7xl mx-auto px-4">
        ...
        <div className="min-h-[500px]">
          <TabsContent
            value="6 ශ්‍රේණිය"
            className="w-full grid place-items-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4"
          >
